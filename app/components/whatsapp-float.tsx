...
export default function WhatsAppFloat() {
  ...
  useEffect(() => {
    // Mostrar o botão flutuante após 10 segundos
  ...
  return (
    ...
    >
      <div className="relative">
        <div className="bg-green-500 rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:bg-green-600 transition-colors">
